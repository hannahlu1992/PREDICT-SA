...
params_CSS = struct('Vcl_fw_bot', Vcl_fw_bot,...
    ...
    'Zf',Zf,...
    'Zmax',Zmax);
[perm_CSS,Perm_CSS] = generate_(params_CSS,100);
...
params_CSC = struct('Vcl_fw_bot', Vcl_fw_bot,...
    ...
    'Zf',Zf,...
    'Zmax',Zmax);
[perm_CSC,Perm_CSC] = generate_(params_CSC,100);
...
params_SCC = struct('Vcl_fw_bot', Vcl_fw_bot,...
    ...
    'Zf',Zf,...
    'Zmax',Zmax);
[perm_SCC,Perm_SCC] = generate_(params_SCC,100);
...
params_SCS = struct('Vcl_fw_bot', Vcl_fw_bot,...
    ...
    'Zf',Zf,...
    'Zmax',Zmax);
[perm_SCS,Perm_SCS] = generate_(params_SCS,100);
...
params_CSS = struct('Vcl_fw_bot', Vcl_fw_bot,...
    ...
    'Zf',Zf,...
    'Zmax',Zmax);
[perm_CSS,Perm_CSS] = generate_(params_CSS,1000);
...
params_CSC = struct('Vcl_fw_bot', Vcl_fw_bot,...
    ...
    'Zf',Zf,...
    'Zmax',Zmax);
[perm_CSC,Perm_CSC] = generate_(params_CSC,1000);
...
params_SCC = struct('Vcl_fw_bot', Vcl_fw_bot,...
    ...
    'Zf',Zf,...
    'Zmax',Zmax);
[perm_SCC,Perm_SCC] = generate_(params_SCC,1000);
...
params_SCS = struct('Vcl_fw_bot', Vcl_fw_bot,...
    ...
    'Zf',Zf,...
    'Zmax',Zmax);
[perm_SCS,Perm_SCS] = generate_(params_SCS,1000);

save('../surrogate-training/validation_data.mat','params_CSS','params_CSC','params_SCC','params_SCS',...
    'perm_CSS','perm_CSC','perm_SCC','perm_SCS',...
    'Perm_CSS','Perm_CSC','Perm_SCC','Perm_SCS');

function [perm,Perm] = generate_(params,Nsim) %Nsim: Number of simulations/realizations
    ...
    Nmc = length(Zf);
    perm = zeros(10000,2,Nsim,Nmc);
    Perm = zeros(3,Nsim,Nmc);
    for i = 1:Nmc
        display(i)
        ...
        for n = 1:Nsim
            ...
            perm(:,:,n,i) = faults{n}.Grid.perm(:,[1,3]);
            Perm(:,n,i) = faults{n}.Perm';
        end
    end
    perm = reshape(perm,[10000,2,Nsim*Nmc]);
    Perm = reshape(Perm,[3,Nsim*Nmc]);
end